...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    siblingLinks: [
      '/order/add-order',
      '/order/process-orders/unshipped',
      '/order/process-orders/download',
      '/order/process-orders/pickup-scheduled',
      '/order/process-orders/not-picked',
      '/order/process-orders/cancel',
      '/order/process-orders/all-orders',
    ],
    isSiblingLink: false,
  },
  {
  ...
  // // },
  // {
  //   path: '/remittance/user-remittance',
  //   title: 'Remittance',
  //   icon: 'mdi mdi-cash-multiple',
  //   class: '',
  //   extralink: false,
  ...
  //   extralink: false,
  //   submenu: [],
  //   siblingLinks: ['/payment/shipping', '/payment/plans'],
  //   isSiblingLink: false,
  // },
  // {
  //   path: '/complaints',
  ...
  //     },
  //     {
  //       path: '/complaints/raised-complaint',
  ...
  //     // },
  //   ],
  //   siblingLinks: ['/settings/courier-priority', '/settings/add-warehouse'],
  //   isSiblingLink: false,
  // },
  // // {
